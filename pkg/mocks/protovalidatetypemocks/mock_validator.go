...
package protovalidatetypemocks
...
func (_m *Validator) Validate(m protoreflect.ProtoMessage) error {
	ret := _m.Called(m)
...
func (_c *Validator_Validate_Call) Run(run func(m protoreflect.ProtoMessage)) *Validator_Validate_Call {
...
func (_c *Validator_Validate_Call) RunAndReturn(run func(protoreflect.ProtoMessage) error) *Validator_Validate_Call {
	_c.Call.Return(run)
	return _c
}
